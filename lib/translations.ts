export const translations = {
  en: {
    ...
    stockOutToday: "Stock Out Today",
    itemsNeedRestocking: "Items need restocking",
    unitsAddedToday: "Units added today",
    unitsSoldToday: "Units sold today",
    stockTrend: "Stock Trend (This Week)",
    ...
    searchOtherBranch: "Search Other Branch",
    availableInOtherBranch: "Available in other branch",
    notAvailableInOtherBranch: "Not available in other branch",
  ...
  am: {
    // Login
    welcomeBack: "እንኳን ደህና መጡ! እባክዎ መለያዎን ያስገቡ",
    email: "ኢሜይል",
    password: "የይለፍ ቃል",
    signIn: "ግባ",
    ...
    crossBranchSearch: "በቅርንጫፎች መካከል ፍለጋ",
    searchOtherBranch: "ሌላ ቅርንጫፍ ፈልግ",
    availableInOtherBranch: "በሌላ ቅርንጫፍ ይገኛል",
    notAvailableInOtherBranch: "በሌላ ቅርንጫፍ አይገኝም",
    ...
    // Transfer
    transfer: "ማስተላለፍ",
    transferProducts: "ምርቶችን ማስተላለፍ",
    newTransferRequest: "አዲስ የማስተላለፊያ ጥያቄ",
    transferHistory: "የማስተላለፊያ ታሪክ",
    fromBranch: "ከቅርንጫፍ",
    toBranch: "ወደ ቅርንጫፍ",
