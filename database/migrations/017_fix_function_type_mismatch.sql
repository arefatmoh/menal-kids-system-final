-- Fix function type mismatches by ensuring exact type compatibility

-- Drop and recreate get_low_stock_products with exact type matching
...
-- Drop and recreate get_high_value_inventory with exact type matching
