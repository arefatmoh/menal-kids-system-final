-- Branch-specific transfer function
-- Users only see products from their logged-in branch
...
-- Test the branch-specific function
SELECT 'Testing branch-specific function for branch1:' as test_name;
SELECT get_transfer_fast_simple('branch1') as result_branch1;

SELECT 'Testing branch-specific function for branch2:' as test_name;
