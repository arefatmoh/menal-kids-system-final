-- Fix SKU generation issue for products table
-- This script will recreate the trigger and function to ensure SKU is auto-generated
...
-- Ensure the generate_sku function exists
...
WHERE event_object_table = 'products' AND trigger_name = 'generate_sku_trigger';
