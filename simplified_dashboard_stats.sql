-- Simplified dashboard stats function
-- Since we no longer have duplicates, we can use simple aggregation
...
BEGIN
    ...
    SELECT
        ...
        -- Stock in today (sum of stock movements) - SIMPLE AGGREGATION
        (
        ...
        -- Stock out today (sum of stock movements) - SIMPLE AGGREGATION
        (
...
SELECT 'Testing simplified get_dashboard_stats function...' as test_status;
SELECT * FROM get_dashboard_stats();

-- Success message
SELECT 'Dashboard stats function simplified! No more complex duplication logic needed.' as status;
